...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    description: Attribute.String;
    id_category: Attribute.UID<'api::category.category', 'name'> &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        minLength: 3;
      }>;
...
export interface ApiDiscountDiscount extends Schema.CollectionType {
  ...
  attributes: {
    discount_id: Attribute.UID & Attribute.Required;
    name: Attribute.String &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        minLength: 3;
      }>;
    discount_percentage: Attribute.Decimal & Attribute.Required;
    active: Attribute.Boolean & Attribute.DefaultTo<true>;
    discount_created_at: Attribute.DateTime;
    discount_updated_at: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMenuMenu extends Schema.CollectionType {
  ...
  attributes: {
    id_menu: Attribute.UID & Attribute.Required;
    name: Attribute.String & Attribute.Required;
    description: Attribute.String;
    ...
    menu_created_at: Attribute.DateTime;
    menu_updated_at: Attribute.DateTime;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user_id: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    order_status: Attribute.Enumeration<['pending', 'completed', 'cancelled']> &
      Attribute.Required &
    ...
    order_updated_at: Attribute.DateTime;
    taxes: Attribute.Relation<'api::order.order', 'oneToMany', 'api::tax.tax'>;
    order_items: Attribute.Relation<
      'api::order.order',
      'oneToMany',
      'api::order-item.order-item'
...
export interface ApiOrderItemOrderItem extends Schema.CollectionType {
  ...
  attributes: {
    order_item_id: Attribute.UID & Attribute.Required;
    ...
    quantity: Attribute.Integer &
      ...
      Attribute.SetMinMax<
        ...
        number
      >;
    order_item_created_at: Attribute.DateTime;
    order_item_updated_at: Attribute.DateTime;
...
export interface ApiPaymentPayment extends Schema.CollectionType {
  ...
  attributes: {
    payment_id: Attribute.UID & Attribute.Required;
    order: Attribute.Relation<
      'api::payment.payment',
      'oneToOne',
      'api::order.order'
    ...
    amount: Attribute.Decimal &
      ...
      Attribute.SetMinMax<
        ...
        number
      >;
    payment_method: Attribute.Enumeration<['cash', 'transfer']> &
      Attribute.Required &
      Attribute.DefaultTo<'cash'>;
    payment_status: Attribute.Enumeration<['pending', 'success', 'refunded']>;
    payment_created_at: Attribute.DateTime;
    payment_updated_at: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTaxTax extends Schema.CollectionType {
  ...
  attributes: {
    tax_id: Attribute.UID & Attribute.Required;
    name: Attribute.String &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        minLength: 3;
      }>;
    tax_percentage: Attribute.Decimal &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 0;
    ...
    tax_created_at: Attribute.DateTime;
    tax_updated_at: Attribute.DateTime;
    order: Attribute.Relation<'api::tax.tax', 'manyToOne', 'api::order.order'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    transaction_id: Attribute.UID & Attribute.Required;
    ...
    amount: Attribute.Decimal &
      ...
      Attribute.SetMinMax<
        ...
        number
      >;
    transactions_created_at: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
